...
| [Battery Capsule Holder (Fusion)](docs/battery-capsule-holder-fusion.md) | ![Top-three-quarter view of the Fusion battery capsule holder v2 — a segmented zig-zag caterpillar body holding six deep teardrop sockets that alternate up and down in a nose-to-tail nested chain, with a rounded head lobe bearing two eye dimples and two antenna nubs at one end and a tapered tail at the other](docs/images/battery-capsule-holder/battery-capsule-holder-fusion-v2-hero.png) | v4 (Fusion) | **Clean-room** Fusion design of the same 6-capsule drawer rack (agent walled off from the OpenSCAD solution). **v2 — zig-zag caterpillar:** the 6 teardrop sockets strung into a nose-to-tail nested zig-zag chain (±10 mm, ~42° spine), a segmented caterpillar body with a head (eyes + antennae) and tail; tighter packing than v1 (~1.45 mm walls vs 2.0). 169 × 61.5 × 24.5 mm, six 18 mm sockets, watertight, prints flat support-free. **v1** (a one-shot filleted-slab test) is kept as the documented baseline. | [STL](designs/battery-capsule-holder-fusion/v2/output/battery-capsule-holder-fusion-v2.stl) |
